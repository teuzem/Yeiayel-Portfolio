    ...
    <section id="blog" className="py-20 px-6 bg-muted/30">
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground">{dict.blog.subtitle}</p>
        </div>
              ...
              >
                {post.featuredImage && (
                  <div className="relative aspect-video overflow-hidden bg-muted">
                    <Image
                      ...
                      alt={
                        isFr
                          ? post.titleFr || post.title || dict.blog.altImage
                          : post.title || dict.blog.altImage
                      }
                      fill
                ...
                <div className="p-4 @md/card:p-6 space-y-3 @md/card:space-y-4">
                  ...
                  <Link
                    ...
                    className="inline-flex items-center gap-1.5 text-primary hover:underline text-xs @md/card:text-sm font-medium"
                  >
                    {dict.blog.readMore}
